...
check_nix_package "openssl_1_1" "openssl_1_1"
...
check_nix_package "fnm" "fnm"
check_nix_package "yarn" "yarn"
check_nix_package "pyenv" "pyenv"
check_nix_package "rbenv" "rbenv"
check_nix_package "ruby-build" "ruby-build"
...
check_nix_package "git-flow" "git-flow"
